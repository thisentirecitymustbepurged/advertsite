...
// ENABLE INITIAL FETCH
const setThereWasInitialFetch = (state, { bool }) =>
  state.merge({
    thereWasInitialFetch: bool
  });
...
export default createReducer(INITIAL_STATE, {
  ...
  [Types.SET_THERE_WAS_INITIAL_FETCH]: setThereWasInitialFetch
});
